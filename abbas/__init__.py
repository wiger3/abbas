...
async def generate_response(messages: list[dict]) -> tuple[dict, str]:
    ...
    try:
        ...
        # raise ReplicateError(title='ZaposciewanieException')
    ...
    #     print(e)
    #     return (input, "Salam alejkum. Tutaj Abbas. Nie mogę gadać bo jestem zapościany. (" + e.title + ")")
    # except ModelError as e:
    #     print(e)
    #     return (input, "Salam alejkum. Tutaj Abbas. Nie mogę gadać bo jestem zapościany. (Prediction failed, please try again)")
